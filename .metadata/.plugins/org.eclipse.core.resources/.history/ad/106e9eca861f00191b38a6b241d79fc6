 ...
 * @author apurritano
 * 
 * List the % of change in femmale employment from the year 2000. 
 *
 ...
 * I split on each comma and filtered results to 'Employment to population ratio, 15+, female (%) (modeled ILO estimate),
 ...
 * change in percent. 
 * Finally I create a write statement to print the country name with the change in percent.
 * I filtered these results to emit the values with a 0% change assuming this was null data points.
 *
 */

public class Q4_Mapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		if (data[3].equals("SL.EMP.TOTL.SP.FE.ZS")){
